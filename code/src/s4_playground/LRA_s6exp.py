...
if __name__ == "__main__":
   ...
   weight_decays = [0.0, 0.033, 0.066, 0.1, 0.2]
   # pos_embs = [{"loc": "all", "theta": 10, "seq_norm": 1024, "learned_freq": False, "b_c_dt_x": "b_c_dt"},
   #             {"loc": "all", "theta": 10_000, "seq_norm": None, "learned_freq": False, "b_c_dt_x": "b_c_dt"},
   #             {"loc": "all", "theta": 10_000, "seq_norm": None, "learned_freq": True, "b_c_dt_x": "b_c_dt"}]

   pos_emb = {}
   n_epochs = 25
   sched_epochs = int(n_epochs * 2)
   b = 64
   num_workers = 0
   d = "cuda"
   lr = 3e-3
